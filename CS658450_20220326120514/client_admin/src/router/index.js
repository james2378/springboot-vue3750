...
const routes = [
	...
	// 参与投票路由
	{
		path: '/vote/table',
		name: 'vote_table',
		component: () => import('../views/vote/table.vue')
	},
	{
		path: '/vote/view',
		name: 'vote_view',
	...
	// 我的投票路由
	{
		path: '/my_vote/table',
		name: 'my_vote_table',
		component: () => import('../views/my_vote/table.vue')
	},
	{
		path: '/my_vote/view',
		name: 'my_vote_view',
		component: () => import('../views/my_vote/view.vue')
	},
	// 取消投票路由
	{
		path: '/cancel_voting/table',
		name: 'cancel_voting_table',
		component: () => import('../views/cancel_voting/table.vue')
	},
	{
		path: '/cancel_voting/view',
		name: 'cancel_voting_view',
		component: () => import('../views/cancel_voting/view.vue')
	},
